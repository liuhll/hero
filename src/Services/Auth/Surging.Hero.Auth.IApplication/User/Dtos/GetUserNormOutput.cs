...
{
    public class GetUserNormOutput : GetUserBasicOutput, IAuditedDto
    {
        ...
        {
            get { return UserGroups.Select(p => p.Id); }
        }

        public string DisplayUserGroups
        {
            get { return string.Join(",", UserGroups.Select(p => p.Name)); }
        }
