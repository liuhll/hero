namespace Surging.Hero.Common
{
    public static class RegExpConstants
    {
        ...
        public const string NormalIdentificationCode = "^[a-zA-Z][a-zA-Z0-9_-]{4,50}$";
        
        //public const string OrgIdentificationRegex = "^[a-zA-Z][a-zA-Z0-9_-]{4,50}$"; //^[a-zA-Z][a-zA-Z0-9_-]{4,50}$
    }
}